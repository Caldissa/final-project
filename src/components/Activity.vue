<template>
    <div
        class="bg-primary dark:bg-white/15 text-white w-full h-full border-l-2 border-transparent dark:border-white/50 h-full"
    >
        <div
        ...
        <div
            class="p-4 md:p-6 h-full flex flex-col gap-4 md:gap-6 overflow-y-scroll"
        >
